    ...
    <>
      ...
      >
        ...
        <InputGroup className='p-2'>
          ...
          <Form.Control placeholder='Váš email' type='email' name="EMAIL" id='mce-EMAIL' />
        ...
        <Button variant='outline-primary' type='submit' name="subscribe" id="mc-embedded-subscribe">
          Potvrdit
        </Button>
      </Form>
    </>
