...
export default function Contact() {
  return (
    <>
      <div className='mt-3 mt-sm-0 d-flex flex-column justify-content-center align-items-center align-items-sm-start'>
        <div>Sportovní 2719, 276 01 Mělník</div>
        <div>adam.pelc94@gmail.com</div>
      </div>
      <div className='ml-sm-3 d-flex flex-column justify-content-center'>
        <iframe
          className='w-100 h-75 border border-footer rounded'
